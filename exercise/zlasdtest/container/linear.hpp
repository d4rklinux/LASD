...
template <typename Data>
void GetAt(uint & testnum, uint & testerr, const lasd::LinearContainer<Data> & con, bool chk, const unsigned long int & ind, const Data & val) {
  bool tst;
  testnum++;
  try {
...
template <typename Data>
void SetAt(uint & testnum, uint & testerr, lasd::LinearContainer<Data> & con, bool chk, const unsigned long int & ind, const Data & val) {
  bool tst;
  testnum++;
  try {
